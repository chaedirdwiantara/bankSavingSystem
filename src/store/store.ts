        ...
        getDefaultMiddleware({
            ...
            serializableCheck: {
                ...
                ignoredActions: [
                    ...
                    'customer/fetchCustomersSuccess',
                    'customer/fetchCustomerByIdSuccess',
                    'customer/createCustomerSuccess',
                    'customer/updateCustomerSuccess',
                    'account/createAccountRequest',
                    'account/fetchAccountsSuccess',
                    'account/fetchAccountByIdSuccess',
                    'account/createAccountSuccess',
                    'deposito/createDepositoTypeRequest',
                    'deposito/updateDepositoTypeRequest',
                    'deposito/fetchDepositoTypesSuccess',
                    'deposito/fetchDepositoTypeByIdSuccess',
                    'deposito/createDepositoTypeSuccess',
                    'deposito/updateDepositoTypeSuccess',
                    'transaction/createDepositRequest',
                    'transaction/createWithdrawalRequest',
                    'transaction/fetchTransactionsSuccess',
                    'transaction/createDepositSuccess',
                    'transaction/createWithdrawalSuccess',
                ],
